...
(function () {
  var e = {
    625: function _(e, t, n) {
      ...
      function a() {
        if (!function () {
          ...
          for (e = document.getElementsByClassName(o)[i].getElementsByTagName("input"), t = 0; t < e.length; t++) {
            if (!e[t].checkValidity()) return !1;
          }
      ...
      function s(e) {
        ...
        !function (e) {
          for (var t = document.getElementsByClassName(o), n = 0; n < t.length; n++) {
            n < e ? (r(t[n]).removeClass("step--active"), r(t[n]).removeClass("step--disabled"), r(t[n]).addClass("step--success"), r(t[n]).addClass("step--hide-content")) : n == e ? (r(t[n]).removeClass("step--disabled"), r(t[n]).removeClass("step--success"), r(t[n]).removeClass("step--hide-content"), r(t[n]).addClass("step--active")) : n > e && (r(t[n]).removeClass("step--active"), r(t[n]).removeClass("step--success"), r(t[n]).addClass("step--disabled"), r(t[n]).addClass("step--hide-content"));
          }
        }(i);
      }
      ...
      r(document).ready(function () {
        !function () {
          for (var e = document.getElementsByClassName("nextTab"), t = 0; t < e.length; t++) {
            e[t].onclick = function () {
              a();
            };
          }

          e = document.getElementsByClassName("selectTab");
    ...
    634: function _(e, t, n) {
      ...
      var r = n(755);
      r(document).ready(function () {
        r(".registration").submit(function (e) {
          e.preventDefault(), r.ajax({
            ...
            success: function success(e) {
              r(".registration").addClass("registration--hidden"), r(".registration-result").addClass("registration--active").addClass("step--success").removeClass("step--disabled").removeClass("step--hide-content");
            },
      ...
      !function (t, n) {
              ...
              (s = k(e, function (e, t) {
                var n = t.length > 0,
                  ...
                  if (m += y, n && y !== m) {
                    ...
                    H.apply(u, b), c && !_o && b.length > 0 && m + t.length > 1 && se.uniqueSort(u);
                  }
            ...
            var t = [["notify", "progress", E.Callbacks("memory"), E.Callbacks("memory"), 2], ["resolve", "done", E.Callbacks("once memory"), E.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", E.Callbacks("once memory"), E.Callbacks("once memory"), 1, "rejected"]],
              ...
              then: function then(e, n, i) {
                  ...
                  return function () {
                    var s = this,
                      ...
                      if (!(e < o)) {
                        ...
                        l = r && ("object" == _typeof(r) || "function" == typeof r) && r.then, m(l) ? i ? l.call(r, a(o, t, B, i), a(o, t, W, i)) : (o++, l.call(r, a(o, t, B, i), a(o, t, W, i), a(o, t, B, t.notifyWith))) : (n !== B && (s = void 0, u = [r]), (i || t.resolveWith)(s, u));
                      }
                    },
                        c = i ? l : function () {
                      try {
                        ...
                        E.Deferred.exceptionHook && E.Deferred.exceptionHook(r, c.stackTrace), e + 1 >= o && (n !== W && (s = void 0, u = [r]), t.rejectWith(s, u));
                      }
                    };
                ...
                return E.Deferred(function (r) {
                  t[0][3].add(a(0, r, m(i) ? i : B, r.notifyWith)), t[1][3].add(a(0, r, m(e) ? e : B)), t[2][3].add(a(0, r, m(n) ? n : W));
                }).promise();
              },
        ...
        function de(e, t) {
          for (var n, r, i = [], o = 0, a = e.length; o < a; o++) {
            (r = e[o]).style && (n = r.style.display, t ? ("none" === n && (i[o] = K.get(r, "display") || null, i[o] || (r.style.display = "")), "" === r.style.display && le(r) && (i[o] = pe(r))) : "none" !== n && (i[o] = "none", K.set(r, "display", n)));
          }
        ...
        function Ce(e, t, n, r, i) {
          for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) {
            if ((o = e[d]) || 0 === o) if ("object" === T(o)) E.merge(p, o.nodeType ? [o] : o);else if (Te.test(o)) {
              for (a = a || f.appendChild(t.createElement("div")), s = (me.exec(o) || ["", ""])[1].toLowerCase(), u = xe[s] || xe._default, a.innerHTML = u[1] + E.htmlPrefilter(o) + u[2], c = u[0]; c--;) {
                a = a.lastChild;
              }
          ...
          n ? (K.set(e, t, !1), E.event.add(e, t, {
            ...
            handler: function handler(e) {
              ...
              if (1 & e.isTrigger && this[t]) {
                if (o.length) (E.event.special[t] || {}).delegateType && e.stopPropagation();else if (o = s.call(arguments), K.set(this, t, o), r = n(this, t), this[t](), o !== (i = K.get(this, t)) || r ? K.set(this, t, !1) : i = {}, o !== i) return e.stopImmediatePropagation(), e.preventDefault(), i.value;
        ...
        E.event = {
          ...
          add: function add(e, t, n, r, i) {
            var o,
                ...
                g,
                v = K.get(e);
            if (Q(e)) for (n.handler && (n = (o = n).handler, i = o.selector), i && E.find.matchesSelector(ae, i), n.guid || (n.guid = E.guid++), (u = v.events) || (u = v.events = Object.create(null)), (a = v.handle) || (a = v.handle = function (t) {
              return void 0 !== E && E.event.triggered !== t.type ? E.event.dispatch.apply(e, arguments) : void 0;
            }), l = (t = (t || "").match(I) || [""]).length; l--;) {
              d = g = (s = ke.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = E.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = E.event.special[d] || {}, c = E.extend({
                type: d,
                origType: g,
                data: r,
                handler: n,
          ...
          special: {
            ...
            click: {
              setup: function setup(e) {
                var t = this || e;
                return ve.test(t.type) && t.click && j(t, "input") && qe(t, "click", Ae), !1;
              },
              trigger: function trigger(e) {
                var t = this || e;
                return ve.test(t.type) && t.click && j(t, "input") && qe(t, "click"), !0;
              },
        ...
        function Ie(e, t) {
          ...
          if (1 === t.nodeType) {
            if (K.hasData(e) && (s = K.get(e).events)) for (i in K.remove(t, "handle events"), s) {
        ...
        function We(e, t, n, r) {
          ...
          var i,
              ...
              h = t[0],
              g = m(h);
          if (g || p > 1 && "string" == typeof h && !v.checkClone && He.test(h)) return e.each(function (i) {
            var o = e.eq(i);
            g && (t[0] = h.call(this, i, o.html())), We(o, t, n, r);
          });

          if (p && (o = (i = Ce(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
            for (s = (a = E.map(be(i, "script"), Re)).length; f < p; f++) {
              l = i, f !== d && (l = E.clone(l, !0, !0), s && E.merge(a, be(l, "script"))), n.call(e[f], l, f);
            }

            if (s) for (c = a[a.length - 1].ownerDocument, E.map(a, Me), f = 0; f < s; f++) {
              l = a[f], ye.test(l.type || "") && !K.access(l, "globalEval") && E.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? E._evalUrl && !l.noModule && E._evalUrl(l.src, {
        ...
        E.extend({
          ...
          clone: function clone(e, t, n) {
            var r,
                ...
                s = e.cloneNode(!0),
                u = se(e);
            if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || E.isXMLDoc(e))) for (a = be(s), r = 0, i = (o = be(e)).length; r < i; r++) {
              Be(o[r], a[r]);
            }
        ...
        function Xe(e, t, n) {
          var r,
              ...
              a,
              s = e.style;
          return (n = n || _e(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || se(e) || (a = E.style(e, t)), !v.pixelBoxStyles() && $e.test(a) && Ue.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a;
        }
        ...
        !function () {
          ...
          c.style && (c.style.backgroundClip = "content-box", c.cloneNode(!0).style.backgroundClip = "", v.clearCloneStyle = "content-box" === c.style.backgroundClip, E.extend(v, {
            ...
            reliableTrDimensions: function reliableTrDimensions() {
              var e, t, n, i;
              return null == s && (e = x.createElement("table"), t = x.createElement("tr"), n = x.createElement("div"), e.style.cssText = "position:absolute;left:-11111px", t.style.height = "1px", n.style.height = "9px", ae.appendChild(e).appendChild(t).appendChild(n), i = r.getComputedStyle(t), s = parseInt(i.height) > 3, ae.removeChild(e)), s;
            }
          }));
        }();
        ...
        function it(e, t, n) {
          ...
          return (!v.boxSizingReliable() && i || !v.reliableTrDimensions() && j(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === E.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === E.css(e, "boxSizing", !1, r), (o = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + rt(e, t, n || (i ? "border" : "content"), o, r, a) + "px";
        }
        ...
        E.extend({
          ...
          style: function style(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
              ...
              "string" == (o = _typeof(n)) && (i = ie.exec(n)) && i[1] && (n = ce(e, t, i), o = "number"), null != n && n == n && ("number" !== o || u || (n += i && i[3] || (E.cssNumber[s] ? "" : "px")), v.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n));
            }
          },
          ...
          E.cssHooks[t] = {
            get: function get(e, n, r) {
              if (n) return !Ke.test(E.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? it(e, t, r) : ze(e, et, function () {
                return it(e, t, r);
              });
            },
        ...
        function ht(e, t, n) {
          ...
          for (function (e, t) {
            ...
            for (n in e) {
              if (i = t[r = Y(n)], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = E.cssHooks[r]) && ("expand" in a)) for (n in o = a.expand(o), delete e[r], o) {
        ...
        E.fn.extend({
          ...
          toggleClass: function toggleClass(e, t) {
            ...
            return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : m(e) ? this.each(function (n) {
              ...
              var t, i, o, a;
              if (r) for (i = 0, o = E(this), a = wt(e); t = a[i++];) {
        ...
        E.extend(E.event, {
          trigger: function trigger(e, t, n, i) {
            ...
            if (a = p = s = n = n || x, 3 !== n.nodeType && 8 !== n.nodeType && !Ct.test(g + E.event.triggered) && (g.indexOf(".") > -1 && (v = g.split("."), g = v.shift(), v.sort()), l = g.indexOf(":") < 0 && "on" + g, (e = e[E.expando] ? e : new E.Event(g, "object" == _typeof(e) && e)).isTrigger = i ? 2 : 3, e.namespace = v.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : E.makeArray(t, [e]), f = E.event.special[g] || {}, i || !f.trigger || !1 !== f.trigger.apply(n, t))) {
              if (!i && !f.noBubble && !y(n)) {
                for (u = f.delegateType || g, Ct.test(u + g) || (a = a.parentNode); a; a = a.parentNode) {
                  h.push(a), s = a;
                }
              ...
              for (o = 0; (a = h[o++]) && !e.isPropagationStopped();) {
                p = a, e.type = o > 1 ? u : f.bindType || g, (c = (K.get(a, "events") || Object.create(null))[e.type] && K.get(a, "handle")) && c.apply(a, t), (c = l && a[l]) && c.apply && Q(a) && (e.result = c.apply(a, t), !1 === e.result && e.preventDefault());
              }

              return e.type = g, i || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(h.pop(), t) || !Q(n) || l && m(n[g]) && !y(n) && ((s = n[l]) && (n[l] = null), E.event.triggered = g, e.isPropagationStopped() && p.addEventListener(g, Et), n[g](), e.isPropagationStopped() && p.removeEventListener(g, Et), E.event.triggered = void 0, s && (n[l] = s)), e.result;
            }
          },
        ...
        function Lt(e, t, n, r) {
          ...
          if (Array.isArray(t)) E.each(t, function (t, i) {
            n || Nt.test(e) ? r(e, i) : Lt(e + "[" + ("object" == _typeof(i) && null != i ? t : "") + "]", i, n, r);
        ...
        $t.href = St.href, E.extend({
          ...
          ajax: function ajax(e, t) {
            ...
            if (d.data && d.processData && "string" != typeof d.data && (d.data = E.param(d.data, d.traditional)), zt(Bt, d, t, C), l) return C;
            ...
            if (T = "abort", m.add(d.complete), C.done(d.success), C.fail(d.error), n = zt(Wt, d, t, C)) {
            ...
            function S(e, t, a, u) {
              ...
              }(d, C, a)), !f && E.inArray("script", d.dataTypes) > -1 && (d.converters["text script"] = function () {}), b = function (e, t, n, r) {
                var i,
                    o,
                    a,
                    s,
              ...
              }(d, b, C, f), f ? (d.ifModified && ((w = C.getResponseHeader("Last-Modified")) && (E.lastModified[i] = w), (w = C.getResponseHeader("etag")) && (E.etag[i] = w)), 204 === e || "HEAD" === d.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = b.state, p = b.data, f = !(x = b.error))) : (x = T, !e && T || (T = "error", e < 0 && (e = 0))), C.status = e, C.statusText = (t || T) + "", f ? v.resolveWith(h, [p, T, C]) : v.rejectWith(h, [C, T, x]), C.statusCode(y), y = void 0, c && g.trigger(f ? "ajaxSuccess" : "ajaxError", [C, d, f ? p : x]), m.fireWith(h, [C, T]), c && (g.trigger("ajaxComplete", [C, d]), --E.active || E.event.trigger("ajaxStop")));
            }
        ...
        v.cors = !!Vt && "withCredentials" in Vt, v.ajax = Vt = !!Vt, E.ajaxTransport(function (e) {
          ...
          if (v.cors || Vt && !e.crossDomain) return {
            send: function send(i, o) {
              ...
              _t3 = function t(e) {
                return function () {
                  _t3 && (_t3 = n = s.onload = s.onerror = s.onabort = s.ontimeout = s.onreadystatechange = null, "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? o(0, "error") : o(s.status, s.statusText) : o(Xt[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                    binary: s.response
                  } : {
                    text: s.responseText
                  }, s.getAllResponseHeaders()));
                };
              }, s.onload = _t3(), n = s.onerror = s.ontimeout = _t3("error"), void 0 !== s.onabort ? s.onabort = n : s.onreadystatechange = function () {
        ...
        E.ajaxSetup({
          ...
          if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Qt, "$1" + i) : !1 !== e.jsonp && (e.url += (At.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function () {
            return a || E.error(i + " was not called"), a[0];
          }, e.dataTypes[0] = "json", o = r[i], r[i] = function () {
            a = arguments;
          }, n.always(function () {
            void 0 === o ? E(r).removeProp(i) : r[i] = o, e[i] && (e.jsonpCallback = t.jsonpCallback, Yt.push(i)), a && m(o) && o(a[0]), a = o = void 0;
          }), "script";
          ...
          var r,
              ...
              a = this,
              s = e.indexOf(" ");
          return s > -1 && (r = xt(e.slice(s)), e = e.slice(0, s)), m(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (i = "POST"), a.length > 0 && E.ajax({
            url: e,
            type: i || "GET",
            dataType: "html",
            data: t
          ...
          E.cssHooks[t] = Ve(v.pixelPosition, function (e, n) {
            if (n) return n = Xe(e, t), $e.test(n) ? E(e).position()[t] + "px" : n;
          });
        }), E.each({
          Height: "height",
          Width: "width"
        ...
        }, E.isArray = Array.isArray, E.parseJSON = JSON.parse, E.nodeName = j, E.isFunction = m, E.isWindow = y, E.camelCase = Y, E.type = T, E.now = Date.now, E.isNumeric = function (e) {
          var t = E.type(e);
